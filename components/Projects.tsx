...
const Projects: React.FC = () => {
  ...
  // This visualization is strictly designed for the 4-column layout (XL screens)
  const getSnakeLine = (index: number, date: string) => {
    const colCount = 4; // Matches xl:grid-cols-4
  ...
  return (
    <section id="projects" className="py-24 bg-dark relative overflow-hidden">
      {/* Container - Increased XL padding to accommodate U-turn lines extending into margins */}
      <div className="max-w-[90rem] mx-auto px-6 md:px-8 xl:px-24">
        <motion.div
        ...
        {/* 
          Grid Setup:
          - grid-cols-1 (Mobile)
          - md:grid-cols-2 (Tablet/Laptop) -> Clean grid, no snake lines
          - xl:grid-cols-4 (Desktop 1280px+) -> Snake layout enabled
          
          Note: xl:gap-y-24 is critical for the snake vertical segments
        */}
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 xl:gap-y-24">
            {projects.map((project, index) => (
              ...
              >
                {/* Render Snake Line Segments (Desktop XL Only) */}
                ...
                >
                  <div className="h-48 overflow-hidden relative">
                    ...
                    <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                      <span className="text-white font-medium px-4 py-2 border border-white rounded-full">{t.projects.view_details}</span>
                    </div>
                  </div>
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                     <div className="flex justify-between items-start mb-2">
                        ...
                        {/* Mobile/Tablet Year Badge (Hidden on XL where timeline exists) */}
                        <span className="xl:hidden text-xs text-gray-500 border border-white/10 px-2 py-0.5 rounded flex items-center gap-1">
          ...
          <div className="fixed inset-0 z-[60] flex items-center justify-center px-4">
            ...
            >
              ...
              <div className="p-8 space-y-6">
                <div>
                    <h3 className="text-lg font-semibold text-white mb-2">{t.projects.modal_about}</h3>
                ...
                <div>
                  <h3 className="text-lg font-semibold text-white mb-3">{t.projects.modal_tech}</h3>
