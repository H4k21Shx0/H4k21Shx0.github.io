...
const ExperienceEducation: React.FC = () => {
  ...
  const experiences = DATA[language].experience;
  ...
  return (
    <section id="experience" className="py-24 bg-dark/50 relative">
      <div className="w-full px-6 md:px-12">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">{t.experience.title}</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-start">
            ...
            >
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <h3 className="text-2xl font-bold text-white">{t.experience.exp_title}</h3>
                </div>
            ...
            >
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <h3 className="text-2xl font-bold text-white">{t.experience.edu_title}</h3>
                </div>
